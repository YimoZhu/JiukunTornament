...
ID = 24
PIN = 'jY0RyHyK9'
CHANNEL_BROKER = grpc.insecure_channel('113.208.112.25:57524') 
...
price_arr_A001 = np.array([[-0.05],[0.05]])
volume_arr_A001 = np.array([[30],[30]])
price_arr_A002 = np.array([[-0.05],[0.05]])
volume_arr_A002 = np.array([[30],[30]])
price_arr_B001 = np.array([[-0.05],[0.05]])
volume_arr_B001 = np.array([[30],[30]])
price_arr_B002 = np.array([[-0.05],[0.05]])
volume_arr_B002 = np.array([[30],[30]])
...
def trading_A001(runtime):
    ...
    volume_arr = np.array([[10,6,2,2,4,6],
                           [6,4,2,2,6,10]])
    """
    price_arr = price_arr_A001
    volume_arr = volume_arr_A001
    #old_price = 99
    while True:
...
def trading_A002(runtime):
    ...
    volume_arr = np.array([[10,6,2,2,4,6],
                           [6,4,2,2,6,10]])
    """
    price_arr = price_arr_A002
    volume_arr = volume_arr_A002
    #old_price = 99
    while True:
...
def trading_B001(runtime):
    ...
    volume_arr = np.array([[10,6,2,2,4,6],
                           [6,4,2,2,6,10]])
    """
    price_arr = price_arr_B001
    volume_arr = volume_arr_B001   
    #old_price = 99
    while True:
...
def trading_B002(runtime):
    ...
    volume_arr = np.array([[10,6,2,2,4,6],
                           [6,4,2,2,6,10]])
    """
    price_arr = price_arr_B002
    volume_arr = volume_arr_B002    
    #old_price = 99                           
    while True:
...
if __name__ == '__main__':
    ...
    with Manager() as mgr:
        ...
        p_arbitrage = Process(target = tradingObjects.arbitrage, args = (runtime,))
